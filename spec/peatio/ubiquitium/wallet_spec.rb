RSpec.describe Peatio::Ubiquitium::Wallet do
  let(:wallet) { Peatio::Ubiquitium::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Ubiquitium::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Ubiquitium::Wallet::SUPPORTED_SETTINGS))
    end
  end
